...
class ModeratorSettleApproval extends StatelessWidget {
  ...
  Future<String> getOutcome(String optionID) async {
    ModeratorPollDecision moderatorPollDecision = ModeratorPollDecision();
    return await moderatorPollDecision.getOutcome(optionID);
  }
    ...
    return Scaffold(
        ...
        body: Padding(
          ...
          child: FutureBuilder<String>(
            future: getOutcome(pollData.outcome),
              ...
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return ListView(
                  children: <Widget>[
                    ...
                    const SizedBox(height: 4),
                    ReadOnlyTextField(
                      text: outcome, // Use the appropriate field from PollData
                    ),
                    ...
                    Row(
                      ...
                      children: <Widget>[
                        ElevatedButton(
                          onPressed: () => settlePoll(context, true,
                              feedbackController.text, pollData.pollId),
                          child: const Text('Approve!'),
                        ),
                        ElevatedButton(
                          onPressed: () => settlePoll(context, false,
                              feedbackController.text, pollData.pollId),
