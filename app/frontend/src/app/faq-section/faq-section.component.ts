...
export class FaqSectionComponent {
  faqItems = [
    ...
    },
    {
      ...
      answer:
        "The prediction power score measures your accuracy in making predictions. It's calculated using an algorithm which is based on the accuracy and uniqueness of your choices.",
    },
    {
    ...
    {
      question:
        "What guidelines and rules do moderator users enforce on Poll'up?",
      answer:
